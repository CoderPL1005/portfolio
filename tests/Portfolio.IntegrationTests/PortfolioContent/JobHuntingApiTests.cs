...
{
    [Theory]
    [InlineData("GET","/api/v1/admin/job-postings")][InlineData("POST","/api/v1/admin/job-postings")][InlineData("GET","/api/v1/admin/job-postings/11111111-1111-1111-1111-111111111111")][InlineData("PUT","/api/v1/admin/job-postings/11111111-1111-1111-1111-111111111111")][InlineData("POST","/api/v1/admin/job-postings/11111111-1111-1111-1111-111111111111/archive")][InlineData("GET","/api/v1/admin/job-applications")][InlineData("POST","/api/v1/admin/job-applications")][InlineData("GET","/api/v1/admin/job-applications/22222222-2222-2222-2222-222222222222")][InlineData("PUT","/api/v1/admin/job-applications/22222222-2222-2222-2222-222222222222/status")][InlineData("POST","/api/v1/admin/job-applications/22222222-2222-2222-2222-222222222222/documents")]
    ...
    public sealed class Fakes:IRequestHandler<GetJobPostingsQuery,PagedResult<JobPostingListItem>>,IRequestHandler<GetJobPostingQuery,JobPostingResult>,IRequestHandler<CreateJobPostingCommand,JobPostingResult>,IRequestHandler<ArchiveJobPostingCommand,JobPostingResult>,IRequestHandler<GetJobApplicationsQuery,PagedResult<JobApplicationListItem>>,IRequestHandler<GetJobApplicationQuery,JobApplicationResult>,IRequestHandler<CreateJobApplicationCommand,JobApplicationResult>
    {
