...
public sealed class JobHuntingApiTests(AuthApiFactory root):IClassFixture<AuthApiFactory>
{
    ...
    public sealed class Fakes:IRequestHandler<GetJobPostingsQuery,PagedResult<JobPostingListItem>>,IRequestHandler<GetJobPostingQuery,JobPostingResult>,IRequestHandler<CreateJobPostingCommand,JobPostingResult>,IRequestHandler<ArchiveJobPostingCommand,JobPostingResult>,IRequestHandler<GetJobApplicationsQuery,PagedResult<JobApplicationListItem>>,IRequestHandler<GetJobApplicationQuery,JobApplicationResult>,IRequestHandler<CreateJobApplicationCommand,JobApplicationResult>,IRequestHandler<GetApplicationPackageReadinessQuery,ApplicationPackageReadinessResult>,IRequestHandler<GetCandidateJobPreferencesQuery,CandidateJobPreferencesResult>,IRequestHandler<UpdateCandidateJobPreferencesCommand,CandidateJobPreferencesResult>,IRequestHandler<GetJobFitAnalysisQuery,JobFitAnalysisResult>
    {
