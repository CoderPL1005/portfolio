...
public sealed class AuthApiFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configuration) =>
            configuration.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["ChatProtection:BurstPermitLimit"] = "1000",
                ["ChatProtection:IpHashSecret"] = "integration-test-chat-ip-hmac-secret-32-characters"
            }));
    ...
    { public Task<SiteSettingsResult> HandleAsync(GetSiteSettingsQuery request, CancellationToken cancellationToken = default) => Task.FromResult(new SiteSettingsResult("Portfolio", null, true, true, true, false, null, null)); }
    ...
    { public Task<DashboardResult> HandleAsync(GetDashboardQuery request, CancellationToken cancellationToken = default) => Task.FromResult(new DashboardResult(1, 2, 3, 4, new(6, 7, 8), 9, [])); }
    ...
    private static AgentSettingsResult Settings(bool enabled=true)=>new(Guid.NewGuid(),"portfolio-agent",enabled,"Gemini","gemini-3.1-flash-lite","Gemini","gemini-embedding-2",1536,"Ground answers", "Welcome","Fallback",6,.6m,.2m);
