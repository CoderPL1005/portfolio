...
public sealed class KnowledgeIndexingWorker(IServiceScopeFactory scopes,IOptions<GeminiSettings> options,ILogger<KnowledgeIndexingWorker> logger):BackgroundService
{
