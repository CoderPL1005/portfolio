...
import { ApplicationCreate, ApplicationDetail, ApplicationItem, CandidateJobPreferences, CandidateJobPreferencesWrite, DocumentItem, JobCreate, JobDetail, JobFitAnalysis, JobSummary, JobWrite, RawJobPostingSummary, ScreenshotSubmissionResult } from './job-hunting.models';
