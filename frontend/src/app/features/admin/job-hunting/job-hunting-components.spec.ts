...
import { ApplicationDetail, ApplicationItem, ApplicationPackage, ApplicationPackageReadiness, ApplicationSubmissionReadiness, JobDetail, JobFitAnalysis, JobSummary } from './job-hunting.models';
...
function mount<T>(component:new(...args:any[])=>T,api:Record<string,any>,id?:string):ComponentFixture<T>{
  const service={packageReadiness:()=>of(packageReadiness()),submissionReadiness:()=>of(submissionReadiness()),applicationPackage:()=>of(applicationPackage()),...api};
