...
@Component({selector:'app-project-editor-shell',imports:[ProjectEditPageComponent,TechnologyManagerComponent],template:`<app-project-edit-page/><div class="catalogue"><app-technology-manager/></div>`,styles:`.catalogue{padding:0 clamp(1.25rem,4vw,2.5rem) clamp(1.25rem,4vw,2.5rem)}`})
